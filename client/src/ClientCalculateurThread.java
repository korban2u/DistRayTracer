...
/**
 * Cette classe permet de gerer la distribution des tâches de calcul entre les noeuds disponibles (Avec les Thread).
 */
public class ClientCalculateurThread {
     ...
     */
    public ClientCalculateurThread(ServiceDistributeur distributeur, ServiceClient client) {
        this.distributeur = distributeur;
        this.client = client;
    }
    
    /**
     * Lance le calcul distribué d'une scène de raytracing.
            ...
            synchronized (threads) {
                for (Thread thread : threads) {
                    try {
                        ...
                        System.err.println("Interruption thread : " + e.getMessage());
                    }
                }
            }
